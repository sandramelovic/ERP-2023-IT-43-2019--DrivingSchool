...
var _categoryActions = require("../../ERP_DrivingSchool_Frontend/src/redux/actions/categoryActions");
var _orders = require("../controllers/orders.controller");
var _axios = _interopRequireDefault(require("axios"));
var _excluded = ["programImage", "description"];
...
var createOrder = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(customer, data) {
    var url, headers, Items, products, newOrder, order, response;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          url = "http://localhost:4000/order"; // Replace with the actual endpoint URL
          headers = {
            Authorization: "Bearer ".concat(customer.metadata.token)
          };
          ...
          _context3.prev = 7;
          _context3.next = 10;
          return _axios["default"].post(url, order, {
            headers: headers
                      ...
                      var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(item) {
                        return _regeneratorRuntime().wrap(function _callee$(_context) {
                          while (1) switch (_context.prev = _context.next) {
                            case 0:
                              _context.next = 2;
                              return _axios["default"].post("http://localhost:4000/orderItem", {
                                amount: item.price,
        ...
        case 14:
          ...
          console.error("Failed to save the order:", _context3.t0);
        case 17:
        case "end":
...
router.post('/order/confirm', /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var updatedCartItems, customer, line_items, session;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          updatedCartItems = req.body.cartItems.map(function (_ref5) {
            var programImage = _ref5.programImage,
          ...
          line_items = req.body.cartItems.map(function (item) {
            return {
              price_data: {
                currency: "rsd",
                product_data: {
                  name: "".concat((0, _categoryActions.setCategory)(item.categoryId), " - ").concat((0, _categoryActions.setProgramType)(item.programTypeId)),
...
router.post('/webhook', express.raw({
  ...
  if (eventType === "checkout.session.completed") {
    stripe.customers.retrieve(data.customer).then( /*#__PURE__*/function () {
      var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(customer) {
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.prev = 0;
              _context5.next = 3;
              return createOrder(customer, data);
            case 3:
              _context5.next = 9;
              break;
            case 5:
              ...
              console.log(_typeof(createOrder));
