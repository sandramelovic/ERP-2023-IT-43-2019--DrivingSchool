  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          _context.next = 8;
          return bcrypt.compare(pwd, foundUser.password);
        case 8:
          match = _context.sent;
          if (!match) {
            _context.next = 21;
          ...
          currentUser = _objectSpread(_objectSpread({}, foundUser), {}, {
            refreshToken: refreshToken
          });
          usersDB.setUsers([].concat(_toConsumableArray(otherUsers), [currentUser]));
          _context.next = 17;
          return fsPromises.writeFile(path.join(__dirname, '..', 'model', 'users.json'), JSON.stringify(usersDB.users));
        case 17:
